...
$sql = "SELECT orderscode,goodsId,goodsName,goodsPrice,goodsCount,total
        from orders where account='".$account."'";
// ChromePhp::log($sql);
...
if($result->num_rows > 0){
    ...
    while($row = $result->fetch_assoc()){
        ...
        createNode($dom,$node_item,"goodsPrice",$row["goodsPrice"]);
